...
export default class selecpersonajeScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('flechas', 'assets/texturas/botones/flechas.png')
    this.load.image('teclas', 'assets/texturas/botones/teclas.png')
  ...
  create() {
    ...
    let botont = this.add.image(140, 560, 'teclas').setScale(1)
    let botonf = this.add.image(760, 560, 'flechas').setScale(1)
